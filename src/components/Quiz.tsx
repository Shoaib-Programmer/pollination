...
const Quiz: React.FC<QuizProps> = ({ isCompulsory = false, onComplete, onSkip }) => {
  ...
  useEffect(() => {
    ...
    const formattedQuestions = quizQuestions.map(q => convertQuizQuestion(q));
      ...
      <div className={styles.controls}>
        {!isAnswerSubmitted ? (
          <>
            ...
            {!isCompulsory && (
              <button className={styles.skipButton} onClick={handleSkipQuiz}>
                Skip Quiz
              </button>
            )}
          </>
