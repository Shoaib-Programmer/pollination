    ...
    const questions: QuizQuestion[] = [
        {
            ...
            question:
                "What percentage of the food we eat is pollinated by bees?",
            correctAnswer: "1/3",
        ...
        },
        {
            ...
            explanation:
                "Pollinators include bees, butterflies, moths, beetles, flies, birds, and bats, but not sharks.",
            difficulty: "medium",
            category: "pollination",
        },
        {
        ...
        },
        {
            ...
            type: QuestionType.MultipleChoice,
            question:
                "How much are pollination services worth to the global economy?",
        ...
        },
        {
            ...
            type: QuestionType.MultipleChoice,
            question:
                "Approximately how many species of pollinators exist worldwide?",
        ...
        },
        {
            ...
            type: QuestionType.MultipleChoice,
            question:
                "What percentage of crop plants require animal pollination?",
            correctAnswer: "80%",
            options: ["20%", "40%", "60%", "80%"],
            explanation:
        ...
        },
        {
            ...
            type: QuestionType.MultipleChoice,
            question:
                "Which animal is known to accidentally pollinate flowers while consuming them?",
